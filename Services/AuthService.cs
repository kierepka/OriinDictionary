...
namespace OriinDic.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<LoginResult> Login(LoginInput loginModel)
        {
            ...
            await ((AuthenticationStateProvider) _authenticationStateProvider).MarkUserAsAuthenticated(token);
        ...
        public async Task Logout()
        {
            ...
            await ((AuthenticationStateProvider) _authenticationStateProvider).MarkUserAsLoggedOut();
            _httpClient.DefaultRequestHeaders.Authorization = null;
        }

        /// <summary>
        /// User authorisation and token retrieve
        /// </summary>
        ...
        private async Task<Token> GetAuthToken(string user, string pwd)
        {
            ...
            using var response = await _httpClient.PostAsync(Const.Token, c);
