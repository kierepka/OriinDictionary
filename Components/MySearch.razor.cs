...
namespace OriinDic.Components
{
    ...
    public partial class MySearch : ComponentBase
    {
        ...
        public MySearch(Toolbelt.Blazor.I18nText.I18nText i18NText) : this()
        {
            I18NText = i18NText;
        }
        ...
        protected Dropdown DropdownLanguage { get; set; }
        ...
        [Parameter]
        public EventCallback<Language?> CurrentLanguage1Changed { get; set; }
        ...
        [Parameter]
        public EventCallback<Language?> CurrentLanguage2Changed { get; set; }
